...
<li class="pc-item">
    <a href="{{ route('superadmin.account.ledgerhead.index') }}" class="pc-link">
        <span class="pc-micon">
...
<li class="pc-item">
    <a href="{{ route('superadmin.user.index') }}" class="pc-link">
        <span class="pc-micon">
...
<li class="pc-item">
    <a href="{{ route('superadmin.role.index') }}" class="pc-link">
        <span class="pc-micon">
...
<li class="pc-item">
    <a href="{{ route('superadmin.setting') }}" class="pc-link">
        <span class="pc-micon">
