                    ...
                    <form id="myForm" method="POST" action="{{ $url }}">
                        ...
                        <div class="row">
                            <div class="mb-3 col-lg-4">
                                ...
                                <input type="text" name="date" id="date" placeholder="Select Date" class="form-control" value="{{ old('date', '') }}" required>
                            </div>
                            <div class="mb-3 col-lg-4">
                                <h5 class="mt-4">Cash in Hand: <span class="text-danger">{{ $cashinhandbalence->closing_debit }}</span></h5>
                            </div>
                            <div class="col-sm-12">
                                <div id="contra-voucher-forms">
                                    <!-- First Contra Voucher Form (initial) -->
                                    <div class="contra-voucher-form">
                                        <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select name="from_head[]" class="form-control">
                                                                ...
                                                                @foreach($selectHead as $item)
                                                                    <option value="{{ $item->ledgers_head_code }}" {{ old('from_head') == $item->ledgers_head_code ? 'selected' : '' }}>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select name="from_bank[]" class="form-control">
                                                                ...
                                                                @foreach($bank as $item)
                                                                    <option value="{{ $item->ledgers_head_code }}" {{ old('from_bank') == $item->ledgers_head_code ? 'selected' : '' }}>
                                                                        {{ $item->ledgers_head_code }} - {{ $item->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <select name="to_head[]" class="form-control">
                                                                <option value="">Ledger Head</option>
                                                                @foreach($selectHead as $item)
                                                                    <option value="{{ $item->ledgers_head_code }}" {{ old('to_head') == $item->ledgers_head_code ? 'selected' : '' }}>
                                                                        {{ $item->ledgers_head_code }} - {{ $item->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select name="to_bank[]" class="form-control">
                                                                <option value="">Bank</option>
                                                                @foreach($bank as $item)
                                                                    <option value="{{ $item->ledgers_head_code }}" {{ old('to_bank') == $item->ledgers_head_code ? 'selected' : '' }}>
                                                                        {{ $item->ledgers_head_code }} - {{ $item->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="bg-light rounded-3 p-3">
                                                    <h5>Cash</h5>
                                                    <input type="number" name="cash_amount[]" class="form-control" placeholder="Cash Amount" step="0.01" value="{{ old('cash_amount', '') }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="bg-light rounded-3 p-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <input type="number" name="cheque_amount[]" placeholder="Cheque Amount" class="form-control" step="0.01" value="{{ old('cheque_amount', '') }}">
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <input type="text" name="cheque_no[]" placeholder="Cheque No" class="form-control" value="{{ old('cheque_no', '') }}">
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <input type="date" name="cheque_date[]" placeholder="Date" class="form-control" value="{{ old('cheque_date', '') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="bg-light rounded-3 p-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <input type="number" name="online_amount[]" placeholder="Online Amount" class="form-control" step="0.01" value="{{ old('online_amount', '') }}">
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <input type="text" name="online_remarks[]" placeholder="Online Remarks" class="form-control" value="{{ old('online_remarks', '') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
