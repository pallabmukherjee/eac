        ...
        <form id="myForm" method="POST" action="{{ $url }}">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <input type="text" id="date" name="date" class="form-control" placeholder="" value="{{ old('date', '') }}">
                </div>
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <select name="payee" class="form-control" id="payee">
                        ...
                        @foreach($beneficiarys as $item)
                            <option value="{{ $item->id }}" {{ old('payee') == $item->id ? 'selected' : '' }}>
                                {{ $item->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <select name="scheme_fund" class="form-control" id="scheme_fund">
                        ...
                        @foreach($schemefund as $item)
                            <option value="{{ $item->ledgers_head_code }}" {{ old('scheme_fund') == $item->ledgers_head_code ? 'selected' : '' }}>
                ...
                <div class="row">
                    <div class="mb-3 col-lg-4">
                        ...
                        <div class="form-control">
                            <label class="me-3"><input type="radio" name="payment_mode" value="1" onclick="togglePaymentFields()"> Cash in Hand</label>
                            <label><input type="radio" name="payment_mode" value="2" onclick="togglePaymentFields()"> Bank</label>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div id="chequeFields" style="display:none;" class="row">
                            <div class="mb-3 col-lg-6">
                                ...
                                <select name="bank" class="form-control" id="bank">
                                    ...
                                    <option value="{{ $item->ledgers_head_code }}" {{ old('bank') == $item->ledgers_head_code ? 'selected' : '' }}>
                                        {{ $item->ledgers_head_code }} - {{ $item->name }}
                                    </option>
                                @endforeach
                                </select>
                            ...
                            <div class="mb-3 col-lg-3">
                                ...
                                <input type="text" name="cheque_no" class="form-control" placeholder="Cheque Number" value="">
                            </div>

                            <div class="mb-3 col-lg-3">
                                <label class="form-label">Cheque Date:</label>
                                <input type="text" id="cheque_date" name="cheque_date" class="form-control" placeholder="Cheque Date" value="">
                            </div>
                        </div>
                ...
                <div class="mb-3 col-lg-6">
                    ...
                    <input type="text" id="reference_date" name="reference_date" placeholder="Reference Date" class="form-control">
                </div>
                    ...
                    <tbody id="ledgerFieldsContainer">
                        <tr class="ledger-fields">
                            ...
                            <td>
                                ...
                                <input type="number" name="amount[]" class="form-control amount-field" placeholder="Amount" value="" step="0.01">
                            </td>
                            <td>
            ...
            <div class="row">
                <div class="mb-3 col-lg-12">
                    ...
                    <textarea name="narration" class="form-control" cols="30" rows="2"></textarea>
                </div>
                <div class="col-lg-12">
