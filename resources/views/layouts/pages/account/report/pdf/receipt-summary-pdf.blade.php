    ...
    <table>
        <thead>
            <tr>
                <th colspan="5">
                    ...
                    <p>Account Head wise Receipt Summary for {{ \Carbon\Carbon::parse($fromDate)->format('d/m/Y') }} to {{ \Carbon\Carbon::parse($toDate)->format('d/m/Y') }}</p>
                </th>
            </tr>
            <tr>
                <th>Account Head</th>
        ...
        <tfoot>
            <tr>
                ...
                <th>{{ number_format($groupedData->sum('total_amount'), 2, '.', '') }}</th>
                <th>0.00</th>
            </tr>
        </tfoot>
    </table>
