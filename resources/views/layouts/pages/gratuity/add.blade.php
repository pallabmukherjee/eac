        ...
        <form method="POST" action="{{ $url }}">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <input type="text" name="relation_name" class="form-control" placeholder="Enter Family Name" value="{{ old('relation_name') }}">
                    @error('relation_name')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <input type="text" name="employee_code" class="form-control" placeholder="Enter Code" value="{{ old('employee_code') }}" required>
                    @error('employee_code')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <input type="text" name="ppo_receive_date" id="ppo_receive_date" class="form-control" value="{{ old('ppo_receive_date') }}" required>
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <div class="form-control">
                        <label class="me-3"><input type="radio" name="retire_dead" value="1"> Retire</label>
                        <label><input type="radio" name="retire_dead" value="2"> Dead</label>
                    </div>
                    @error('retire_dead')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <select name="financial_year" class="form-control">
                        ...
                        @foreach($financialYears as $item)
                            <option value="{{ $item->id }}" {{ old('financial_year') == $item->year ? 'selected' : '' }}>
                                {{ $item->year }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <div class="form-control">
                        <label class="me-3"><input type="radio" name="alive_status" value="1"> Alive</label>
                        <label><input type="radio" name="alive_status" value="2"> Dead</label>
                    </div>
                    @error('alive_status')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <div class="form-control">
                        <label class="me-3"><input type="radio" name="loan_status" value="1"> Yes</label>
                        <label><input type="radio" name="loan_status" value="2"> No</label>
                    </div>
                    @error('loan_status')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <div class="form-control">
                        <label class="me-3"><input type="radio" name="relation_died" value="1" onclick="togglePaymentFields()"> Dead</label>
                        <label><input type="radio" name="relation_died" value="2" onclick="togglePaymentFields()"> Alive</label>
                    </div>
                    @error('relation_died')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="col-lg-4" id="dateofdeathfield" style="display: none;">
                    <div class="row">
                        <div class="mb-3 col-lg-6">
                            ...
                            <input type="text" name="warrant_name" class="form-control" value="{{ old('warrant_name') }}">
                            @error('warrant_name')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3 col-lg-6">
                            ...
                            <input type="text" name="warrant_adhar_no" class="form-control" value="{{ old('warrant_adhar_no') }}">
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <input type="number" name="sanctioned_amount" class="form-control" placeholder="Enter Amount" value="{{ old('sanctioned_amount') }}" required>
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <input type="number" name="ppo_amount" class="form-control" placeholder="Enter Amount" value="{{ old('ppo_amount') }}" required>
                    @error('ppo_amount')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <input type="number" name="bank_ac_no" class="form-control" placeholder="Enter Bank Account No" value="{{ old('bank_ac_no') }}" required>
                    @error('bank_ac_no')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-lg-4">
                    ...
                    <input type="text" name="ifsc" class="form-control" placeholder="Enter IFSC Code" value="{{ old('ifsc') }}" required>
                    @error('ifsc')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
